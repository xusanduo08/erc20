...
mod erc20 {
        ...
        impl ::scale::Encode for __ink_EventBase {
            fn encode_to<__CodecOutputEdqy: ::scale::Output + ?::core::marker::Sized>(
                ...
                match *self {
                    ...
                    __ink_EventBase::Approve(ref aa) => {
            ...
            fn decode<__CodecInputEdqy: ::scale::Input>(
                    ...
                    })?
                {
                    ...
                    __codec_x_edqy if __codec_x_edqy
                        ...
                        return (move || {
                            ::core::result::Result::Ok(
                                __ink_EventBase::Approve({
                                    let __codec_res_edqy = <Approve as ::scale::Decode>::decode(
                                        __codec_input_edqy,
                                    );
                                    match __codec_res_edqy {
                                        ::core::result::Result::Err(e) => {
                                            return ::core::result::Result::Err(
                                                e.chain("Could not decode `__ink_EventBase::Approve.0`"),
                                            );
                                        }
                                        ::core::result::Result::Ok(__codec_res_edqy) => {
                                            __codec_res_edqy
    ...
    const _: () = {
        impl From<Approve> for __ink_EventBase {
            fn from(event: Approve) -> Self {
                Self::Approve(event)
            }
        }
    };
        ...
        impl ::ink::env::Topics for __ink_EventBase {
                ...
                B: ::ink::env::topics::TopicsBuilderBackend<E>,
            {
                match self {
                    ...
                    Self::Approve(event) => {
                        <Approve as ::ink::env::Topics>::topics::<E, B>(event, builder)
                    }
                    _ => {
    ...
    const _: () = ::ink::codegen::utils::consume_type::<
        ...
        >,
    >();
    impl ::ink::codegen::EventLenTopics for Approve {
        type LenTopics = ::ink::codegen::EventTopics<0usize>;
    }
    const _: () = ::ink::codegen::utils::consume_type::<
        ::ink::codegen::EventRespectsTopicLimit<
    ...
    const _: () = {
        ...
        #[automatically_derived]
        impl ::scale::EncodeLike for Approve {}
    };
    #[allow(deprecated)]
    const _: () = {
        #[automatically_derived]
        impl ::scale::Decode for Approve {
            fn decode<__CodecInputEdqy: ::scale::Input>(
                __codec_input_edqy: &mut __CodecInputEdqy,
            ) -> ::core::result::Result<Self, ::scale::Error> {
                ::core::result::Result::Ok(Approve {
                    from: {
                        let __codec_res_edqy = <AccountId as ::scale::Decode>::decode(
                            __codec_input_edqy,
                        );
                        match __codec_res_edqy {
                            ::core::result::Result::Err(e) => {
                                return ::core::result::Result::Err(
                                    e.chain("Could not decode `Approve::from`"),
                                );
                            }
                            ::core::result::Result::Ok(__codec_res_edqy) => {
                                __codec_res_edqy
                    ...
                    to: {
                        ...
                        match __codec_res_edqy {
                            ::core::result::Result::Err(e) => {
                                return ::core::result::Result::Err(
                                    e.chain("Could not decode `Approve::to`"),
                                );
                            }
                            ::core::result::Result::Ok(__codec_res_edqy) => {
                                __codec_res_edqy
                    ...
                    value: {
                        ...
                        match __codec_res_edqy {
                            ::core::result::Result::Err(e) => {
                                return ::core::result::Result::Err(
                                    e.chain("Could not decode `Approve::value`"),
                                );
                            }
                            ::core::result::Result::Ok(__codec_res_edqy) => {
                                __codec_res_edqy
    ...
    const _: () = {
        impl ::ink::env::Topics for Approve {
            type RemainingTopics = [::ink::env::topics::state::HasRemainingTopics; 1usize];
            fn topics<E, B>(
                &self,
                builder: ::ink::env::topics::TopicsBuilder<
                ...
                B: ::ink::env::topics::TopicsBuilderBackend<E>,
            {
                builder
                    .build::<Self>()
                    .push_topic::<
                        ::ink::env::topics::PrefixedValue<[u8; 14usize]>,
                    >(
                        &::ink::env::topics::PrefixedValue {
                            value: b"Erc20::Approve",
                            prefix: b"",
                        },
                    )
                    .finish()
    ...
    const _: () = {
        ...
        impl Erc20 {
            ...
            pub fn approve(&mut self, to: AccountId, value: Balance) -> Result<()> {
                ...
                self.env().emit_event(Approve { from: sender, to, value });
                Ok(())
            }
                ...
                ::ink::metadata::ContractSpec::new()
                    ...
                    .events([
                        ::ink::metadata::EventSpec::new("Transfer")
                            ...
                            .docs([])
                            .done(),
                        ::ink::metadata::EventSpec::new("Approve")
                            .args([
                                ::ink::metadata::EventParamSpec::new("from")
                                    .of_type(
                                        ::ink::metadata::TypeSpec::with_name_segs::<
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
            ::core::fmt::Formatter::write_str(
                ...
                match self {
                    ...
                    Error::AllowancesTooLow => "AllowancesTooLow",
                },
            )
        }
    }
            ...
            fn decode<__CodecInputEdqy: ::scale::Input>(
                    ...
                    })?
                {
                    ...
                    __codec_x_edqy if __codec_x_edqy
                        ...
                        #[allow(clippy::redundant_closure_call)]
                        return (move || {
                            ::core::result::Result::Ok(Error::AllowancesTooLow)
                        })();
                    }
                    _ => {
                        #[allow(clippy::redundant_closure_call)]
